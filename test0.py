...
# Ciclo: implementati i profili di velocità in base al gusto (flavour) la parte periodica è dinamica
# Ciclo: motore fermo in fase END_STD o END_EXT (blinking blue)
# Lettura tasto/selettore: skip comunicazione BLE e ciclo principale se è in conrso una cattura impulsi
# TODO: migliorare beep, raddoppio durata del beep singolo ... ~OK
#    1. da valutare se sia meglio svincolarsi dal timer del lampeggio
# TODO: lampeggio blu se ciclo selezionato da App ... OK
# TODO: gestione extra time se ciclo selezionato da App ... ~OK
#    1. definire quale ciclo esegue
#    2. aggiustare il tempo nel GetStatus per la progress bar
# Per la versione release creare un main.py che contiene OTA e poco altro e aggiorna più file, incluso start.mpy
# in base alle info contenute nel file version.json
...
machine_cfg = {} # variabile globale per leggere da file json la configurazione della macchina
...
class Config:
    ...
    # Questo dizionario attribuisce ad ogni flavour la descrizione di uno speed profile
    # 0 = Non Periodco (% della durata del ciclo, velocità in rpm), la somma dei % deve essere 100
    # n = Periodico (durata in secondi, velocità in rpm) con inizio periodo @ n
    f2s = {
        # "000": [0, (30,50.0), (30,100.0), (40,50.0)], # Ciclo base non alternato
        "000": [3, (45,60.0), (2,0.0), (5,110.0), (3,0.0)], # CocoWhip Protein
        "001": [3, (20,60.0), (3,0.0), (3,120.0), (5.6,0.0)],
        "002": [3, (10,120.0), (3,0.0), (3,120.0), (3,0.0)],
        "003": [3, (10,120.0), (3,0.0), (3,120.0), (3,0.0)],
        "004": [3, (10,120.0), (3,0.0), (3,120.0), (3,0.0)],
        "005": [3, (10,120.0), (3,0.0), (3,120.0), (3,0.0)],
        "006": [3, (10,120.0), (3,0.0), (3,120.0), (3,0.0)],
        "007": [3, (10,120.0), (3,0.0), (3,120.0), (3,0.0)],
        "008": [3, (10,120.0), (3,0.0), (3,120.0), (3,0.0)],
        "009": [3, (10,120.0), (3,0.0), (3,120.0), (3,0.0)],
        "010": [0, (30,50.0), (30,100.0), (40,50.0)],
        "011": [3, (20,60.0),(3,0.0),(3,120.0),(4.5,0.0)],
        "012": [3, (20,60.0),(3,0.0),(3,120.0),(4.5,0.0)],
        "013": [3, (20,60.0),(3,0.0),(3,120.0),(4.5,0.0)],
        "014": [3, (20,60.0),(3,0.0),(3,120.0),(4.5,0.0)],
        "015": [3, (20,60.0), (3,0.0), (3,120.0), (5.6,0.0)],
        "016": [3, (20,60.0),(3,0.0),(3,120.0),(4.5,0.0)],
        "017": [3, (20,60.0), (3,0.0), (3,120.0), (5.6,0.0)],
        "018": [3, (10,120.0), (3,0.0), (3,120.0), (3,0.0)],
        "019": [3, (10,120.0), (3,0.0), (3,120.0), (3,0.0)],
        "020": [3, (10,120.0), (3,0.0), (3,120.0), (3,0.0)],
        "021": [3, (20,60.0),(3,0.0),(3,120.0),(4.5,0.0)],
        "022": [3, (20,60.0),(3,0.0),(3,120.0),(4.5,0.0)],
        "023": [3, (20,60.0), (3,0.0), (3,120.0), (5.6,0.0)],
        "024": [3, (10,120.0), (3,0.0), (3,120.0), (3,0.0)],
        "025": [3, (20,60.0), (3,0.0), (3,120.0), (5.6,0.0)],
        "026": [3, (10,120.0), (3,0.0), (3,120.0), (3,0.0)],
        "027": [3, (20,60.0),(3,0.0),(3,120.0),(4.5,0.0)],
        "028": [3, (20,60.0),(3,0.0),(3,120.0),(4.5,0.0)],
        "029": [3, (20,60.0),(3,0.0),(3,120.0),(4.5,0.0)],
        "030": [3, (10,120.0), (3,0.0), (3,120.0), (3,0.0)],
        "031": [3, (20,60.0),(3,0.0),(3,120.0),(4.5,0.0)],
        "032": [3, (20,60.0),(3,0.0),(3,120.0),(4.5,0.0)],
        "033": [3, (10,120.0), (3,0.0), (3,120.0), (3,0.0)],
        "050": [3, (30,70.0), (2,0.0), (5,100.0), (3,0.0)], # CocoWhip Plain
        "051": [3, (45,60.0), (2,0.0), (5,110.0), (3,0.0)]  # CocoWhip Protein
        }
...
class Hardware:
    ...
    def _init_pins(self):
        ...
        self.c_tec_pow = Pin('GPIO21', Pin.OUT) # attivazione TEC
        self.c_tec_pol = Pin('GPIO22', Pin.OUT) # inversione polarità TEC
...
class UIManager:
    ...
    def handle_start_irq(self, pin):
        ...
        self.pulse_started = True # Semaforo rosso (main loop e bluetooth)
        state = disable_irq() # Disabilita interrupt
        d1 = time_pulse_us(pin, 0, 20000) # Timeout 20ms (la durata massima teorica è 16000 us)
        if 1700 <= d1 <= 2100 or 3700 <= d1 <= 16100: # Evita falsi trigger sotto 3.8ms
            d2 = time_pulse_us(pin, 0, 10000) # Timeout 10ms (la durata massima teorica è 5000 + 3100 us)
        ...
        self.pulse_started = False # Semaforo verde (main loop e bluetooth)
                ...
                if action == 'sw_release':
                    ...
                    if self.state_machine.standby:
                        if len(self.sel) > 3: # In standby filtro più severo
                            self.sel.pop(0)
                    elif len(self.sel) > 2: # In condizioni normali filtro più leggero
                        self.sel.pop(0)
...
class StateMachine:
    def __init__(self, hardware, sensor_data, event_queue):
        ...
        self.tab_speed_profile = [] # tabella con profilo di velocità completo: makeSpeedProfile(...)
    ...
    def process_event(self, event):
        ...
        elif event == EventCodes.START_LONG_PRESSED:
            self._handle_cycle_end()

    def makeSpeedProfile (self, f2s, TC = 240000, flavour = '000'):
        """Crea la tabella Tempo/Velocità completa in base alla durata del ciclo"""
        tab_speed = []
        p_start = f2s[flavour][0] # puntatore all'inizio della parte periodica, 0 = non periodico
        if p_start == 0:
            t = 0
            for i in range(1, len(f2s[flavour])):
                tab_speed.append((t + f2s[flavour][i][0]*TC/100, f2s[flavour][i][1]))
                t = t + f2s[flavour][i][0]*TC/100
        elif p_start > 0:
            if p_start > len(f2s[flavour]) - 2:
                print('Il periodo deve essere almeno lungo 2')
                return []
            else:
                i = 1
                tab_speed.append((f2s[flavour][i][0]*1000, f2s[flavour][i][1])) # il tempo è in ms
                i += 1
                next_t = tab_speed[0][0] + f2s[flavour][i][0]*1000
                while next_t <= TC:
                    # print(i)
                    tab_speed.append((next_t, f2s[flavour][i][1]))
                    i +=1
                    if i > len(f2s[flavour])-1:
                        i = p_start
                    next_t = tab_speed[-1][0] + f2s[flavour][i][0]*1000
        else:
            print ('Errore nella struttura ')
            return []
    ...
    def _handle_start_pressed(self):
        ...
        if self.current_status == MachineStates.READY:
            ...
            self.num_pause = 0
            # Creo il profilo di velocità completo a partire dalla descrizione del profilo
            self.tab_speed_profile = self.makeSpeedProfile(Config.f2s, self.cycle_duration, self.flavour)
        ...
        elif self.current_status == MachineStates.END_STD:
            # Se flavour != '000' --> RUN_EXT, tempo ciclo 120s
            #    Se option == 1 --> Tempo ciclo 180s
            if self.flavour != '000':
                self.current_status = MachineStates.RUN_EXT
                self.cycle_duration = Config.EXT_CYCLE_DURATIONS[self.option] * 1000
            else:
                self.current_status = MachineStates.IDLE
        
        elif self.current_status == MachineStates.END_EXT:
            self.current_status = MachineStates.IDLE
    ...
    def _handle_external_event(self):
        ...
        # Evita che la macchina tenti di andare in standby durante la comunicazione
        self.status_init_time = time.ticks_ms() 

    def update_cycle_duration(self, selector):
        """Aggiorna durata ciclo in base al selettore"""
        # Aggiornare solo in stati specifici come IDLE o PAUSE, non in RUN
        if self.current_status in [MachineStates.RUN_STD, MachineStates.RUN_EXT,
                                   MachineStates.END_STD, MachineStates.END_EXT,
                                   MachineStates.ERROR]:
            pass
            return
        elif 1 <= selector <= len(Config.STD_CYCLE_DURATIONS):
    ...
    def run_cycle(self):
        ...
        if self.total_time >= self.cycle_duration:
            ...
            # Scorre il profilo di velocità completo per trovare il valore di velocità in base
            # all'avanzamento del ciclo 
            for i in range(0, len(self.tab_speed_profile)):
                if self.total_time <= self.tab_speed_profile[i][0]:
                    # print(self.total_time, self.tab_speed_profile[i][0], i)
                    break
            self.motor_speed = self.tab_speed_profile[i][1]
    ...
    def update_leds(self):
        ...
        if self.blink:
            ...
            sw = 1
            self.beep_count = 0 # i beep sono possibili solo con led lampeggiante
        ...
        if self.beep_count > 0:
            if self.led_on:
                self.buz_on = not self.buz_on    # Dimezzo la frequenza di beep del buzzer
            print('Buzzer :', self.buz_on)
            self.hardware.buzzer.duty_u16(int(self.buz_on * 128 * 65535 / 255))
...
class BluetoothManager:
    ...
    def __init__(self, hardware, ui_manager, state_machine, sensor_data, event_queue):
        ...
        self.peripheral = BLESimplePeripheral(self.ble, ble_name) # ble_name letto da config.json
        self.peripheral.on_write(self._on_rx)

        # Indirizzo MAC Bluetooth
        addr = self.ble.config('mac')[1]
        machine_cfg["Info"]["Bluetooth Address"] = [29,
                                                    str(hex(addr[0])) + ":"+
                                                    str(hex(addr[1])) + ":"+
                                                    str(hex(addr[2])) + ":"+
                                                    str(hex(addr[3])) + ":"+
    ...
    def _query_SendCode(self, data):
        ...
        if (int(chr(dm_code[-2])) == chk1) and (int(chr(dm_code[-1])) == chk2):
            ...
            self.state_machine.flavour = dm_code[5:8].decode('utf-8') # estraggo il codice ascii del flavour per il GetStatus
    ...
    def _query_ExtraTime(self, data):
        ...
        if data[7] not in [0, 1]:
            return b'\xAA\x00\x01\x81\x85\x00\x01\x03' # NACK + codice errore "03 = Generic operation error"
        self.state_machine.extra_time = (data[7] == 1)
        return b'\xAA\x00\x01\x01\x85\x00\x00' # ACK

    
    def _query_SetInfo(self, data):
        # Da verificare ....
        info_id = data[7]
        info_data = data[8:8+list(data[8:]).index(0)] # dati terminati da 0
    ...
    def _query_GetInfo(self, info_id):
        res = bytearray(b'\xAA\x00\x01\x01\x87\x00\x20')
        ...
        if info_id == 0x00: # Board Serial Number
            ...
            info_data = machine_cfg["Network"]["SSID"]
            L = min(machine_cfg["Max Data Length"], len(machine_cfg["Network"]["SSID"]))
        elif info_id == 0x06: # WiFi Password
            info_data = machine_cfg["Network"]["PASSWORD"]
            L = min(machine_cfg["Max Data Length"], len(machine_cfg["Network"]["PASSWORD"]))
        else:
            # Infomation Identifier non gestito
...
class GelatoMachine:   
    ...
    def _check_ota_update(self):
        ...
        try:
            ...
            ota_updater = OTAUpdater(machine_cfg["Network"]["SSID"],
                                     ...
                                     machine_cfg["Network"]["FW_URL"],
                                     machine_cfg["Network"]["FILES"])
        ...
        while True:
            if not self.ui_manager.pulse_started:
                try:
                    ...
                    self.state_machine.update_cycle_duration(self.ui_manager.selector)
    ...
    def _handle_machine_states(self):
        ...
        # Transizione Idle -> Ready
            ...
            self.state_machine.flavour = '000'
        ...
        # Stato Ready
            ...
            if self.state_machine.status_elapsed_time >= Config.STANDBY_TIMEOUT:
                ...
                if self.state_machine.flavour == "000": 
        ...
        # Stati di esecuzione: RUN_STD
        elif self.state_machine.current_status == MachineStates.RUN_STD:
            if self.state_machine.flavour == "000": 
                self.state_machine.r, self.state_machine.g, self.state_machine.b = 0, 201, 204
            else:
                self.state_machine.r, self.state_machine.g, self.state_machine.b = 0, 0, 255
        ...
        # Stati di esecuzione: RUN_EXT
        elif self.state_machine.current_status == MachineStates.RUN_EXT:
            self.state_machine.r, self.state_machine.g, self.state_machine.b = 255, 0, 255 # BLINKING MAGENTA
            self.state_machine.blink = True
            self.state_machine.run_cycle()
        ...
        # Stato Pausa
            ...
            if self.state_machine.status_elapsed_time >= Config.PAUSE_TIMEOUT:
                self.state_machine.beep_count = 8
                
        # Stati di fine
        elif self.state_machine.current_status in [MachineStates.END_STD, MachineStates.END_EXT]:
            self.state_machine.r, self.state_machine.g, self.state_machine.b = 255, 30, 0 # BLINKING AMBER
            self.state_machine.blink = True
            # self.hardware.buzzer.duty_u16(0)
            self.hardware.motor.duty_u16(0) # Meglio spegnere, se continua a mantecare cresce in volume
            
            if self.state_machine.status_elapsed_time >= Config.END_TIMEOUT:
                # self.hardware.motor.duty_u16(0)
                self.hardware.c_tec_pow.value(0)
                self.state_machine.beep_count = 8 # inutile? nello stato successivo non c'è lampeggio ...
                
        # Cattura stati non gestiti
        else:
            self.state_machine.r, self.state_machine.g, self.state_machine.b = 255, 0, 0 # STATIC RED
            self.state_machine.blink = False
